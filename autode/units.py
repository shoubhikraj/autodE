...
sec = BaseUnit(name="s", aliases=["seconds", "second"])

minute = Unit(
    name="min", conversion=Constants.s_to_min, aliases=["minute", "minutes"]
)

ps = Unit(name="ps", conversion=Constants.s_to_ps, aliases=["picoseconds"])
